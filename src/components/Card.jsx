...
function Card ({ pokemon}) {
    ...
    return (
        <div className="flex flex-col items-center gap-2 w-40 bg-gray-200 rounded-lg p-4 w-50 mx-auto hover:scale-105 transition-transform duration-300">
            ...
            <div className="flex flex-col gap-1 mt-2">
                <h2>
                    <span className="font-bold text-gray-500">Altura:</span> {pokemon.height / 10} m
                </h2>
                <h2>
                    <span className="font-bold text-gray-500">Peso:</span> {pokemon.weight / 10} kg
                </h2>
            </div>
            </div>
    )
